                            ...
                            <div class="p-4 mb-0 border-0 p-md-5 p-lg-0">
                                ...
                                <div class="pt-0">
                                    <form class="my-4" method="POST" action="{{ route('register') }}">
                                        @csrf
                                            ...
                                            <div class="mb-1 form-group">
                                                ...
                                                <input class="form-control" name="name" type="text" id="name" required="" placeholder="Enter your Name" :value="old('name')">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <a
                                                class="mb-3 border btn text-dark fw-normal d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="col-12">
                                            <a
                                                class="mb-3 btn btn-primary fw-normal d-flex align-items-center justify-content-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
