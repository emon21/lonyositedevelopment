...
@section('admin')
      ...
      {{--       
         ...
         <form action="{{ route('admin.mail.settings.test') }}" method="POST" class="mt-3">
            ...
            <div class="input-group">
               ...
               {{-- <textarea name="mail_msg" class="form-control" rows="3"
                  placeholder="Paste Google Map Embed URL here"></textarea> --}}
   ...
   <div class="d-flex justify-content-center border-top ">
       <button onclick="resetSettings()"
               class="px-2 py-2 my-2 btn btn-danger btn-sm d-flex align-items-center"
               style="width:180px"
               type="button">
                  ...
                  <div class="tab-pane fade" id="v-pills-social" role="tabpanel">
                     ...
                     <div class="p-3 mt-1">
                        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                           ...
                           <small class="text-muted">This field is automatically updated from the links above.</small> --}}
                        ...
                        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="gap-2 d-flex justify-content-between align-item-center">
                              ...
                              <textarea name="site_description" class="form-control"
                                 rows="4" cols="10" value="{{ old('site_description', $settings['site_description'] ?? 'This is a demo website description.') }}">{{ $settings['site_description'] ?? ''}}</textarea>
                           </div>
                            <div class="mb-3 col-md-6">
            ...
            function resetSettings() {
               Swal.fire({
                  ...
                  if (result.isConfirmed) {
                     axios.post("{{ route('admin.settings.reset') }}")
                        .then(res => {
                           Swal.fire(
                              'Reset Done!',
                              res.data.message,
