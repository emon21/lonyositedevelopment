@extends('backend/layouts/admin-master', ['title' => 'Edit Slider'])
@section('admin')
   <!-- Start breadcrumb -->
   <div class="container-fluid">
      <div class="px-1 py-3 d-flex align-items-sm-center flex-sm-row flex-column">
         <div class="flex-grow-1">
            <h4 class="m-0 fs-18 fw-semibold">Edit Slider</h4>
         </div>
         <div class="text-end">
   ...
   <div class="container-fluid">
      ...
      <div class="card">
         <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="my-2 card-title">Edit Slider</h4>
         ...
         <div class="card-body">
            <form action="{{ route('admin.slider.update',$slider) }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="mb-3 form-group row">
                  ...
                  <div class="col-lg-12 col-xl-12">
                     <input type="text" class="form-control" value="{{ old('link',$slider->link) }}" placeholder="Your link Here...."
               ...
               <div class="mb-3">
                  ...
                  <textarea class="form-control" id="description" rows="5" spellcheck="false" name="description"
                     value="{{ old('description',$slider->description) }}" placeholder="Description Here....">{{ $slider->description }}</textarea>
                ...
                <fieldset class="mb-3">
                        ...
                        <div class="gap-2 col-sm-11 d-flex">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="gridRadios2" value="inactive" {{ $slider->status == 'inactive' ? 'checked' : '' }}>
               ...
               <div class="mb-3 form-group">
                  ...
                  <!-- Image Preview -->
                        <img src="{{ $slider->photo ? asset('uploads/slider/' . $slider->photo) : asset('uploads/no_image.jpg') }}"
