@extends('frontend/layouts/frontend-master', ['title' => 'Single Team'])
    ...
    <div class="breadcrumb-wrapper light-bg">
        <div class="container">
            ...
            <div class="breadcrumb-content">
                <h1 class="breadcrumb-title pb-0">Team Details</h1>
                    ...
                    <div class="breadcrumb-menu-wrap">
                        <div class="breadcrumb-menu">
                            <ul>
                                ...
                                <li aria-current="page">Team Details</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="lonyo-team-d-thumb" data-aos="fade-up" data-aos-duration="700">
                        <img src="{{ $team->photo ? asset('uploads/team/' . $team->photo) : asset('uploads/no_image.jpg') }}"
                            alt="Team Image" style="width: 526px; height: 550px;">
                    </div>
                </div>
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com">
                                        <svg width="10" height="20" viewBox="0 0 9 16" fill="none"
                                ...
                                <li>
                                    <a href="https://www.instagram.com">
                                        <svg width="19" height="19" viewBox="0 0 16 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
